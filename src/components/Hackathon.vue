      ...
      <div class="about-text col-md-6">
        <p class="lead" style="font-size: 18px;padding-top: 0;">
          ...
          <strong
            ...
            ></strong
          >
          est un hackathon dédié à l’industrie, un évènement destiné à bousculer
          les idées et à faire émerger de nouveaux projets. Des équipes aux
          divers talents s’affrontent pendant tout un week-end pour concevoir
        ...
        <ul class="icon-list">
          <li>
            ...
            <p>
              54 h pour participer à l’aventure Usine 4.0. Déplacer l’industrie
              dans ses fondements, l’interroger sur ses process, la rendre plus
              agile, plus inventive.
            </p>
          </li>
          <li>
            <span class="icon-list-icon" data-animation="bounceIn"
            ...
            <p>
              54 h pour innover à plusieurs. Un concentré d’énergie créative de
              tous bords : développeurs, ingénieurs, designers, bricoleurs,
              utilisateurs, marketeurs…
            </p>
          </li>
          <li>
            <span class="icon-list-icon" data-animation="bounceIn"
