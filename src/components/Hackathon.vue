                ...
                <div class="hero-features row" style="margin-top: 45px;">
                    <div class="hero-features-left col-md-6">
                        <div class="video-embed">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/QoWu4FlbYus" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                    <!-- videos\Reportage_HIC_Version_ES_DEF.m4v -->
                        </div>
                        <p class="lead">
