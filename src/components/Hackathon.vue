    ...
    <div class="container">
        ...
        <div class="about-row row">
          ...
          <div class="about-text col-md-6">
            ...
            <ul class="icon-list">
              <li>
                <span class="icon-list-icon" data-animation="bounceIn"><i class="far fa-hand-point-up"></i></span>
              ...
              <li>
                <span class="icon-list-icon" data-animation="bounceIn"><i class="far fa-heart"></i></span>
              ...
              <li>
                <span class="icon-list-icon" data-animation="bounceIn"><i class="far fa-lightbulb"></i></span>
