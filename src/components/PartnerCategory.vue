        ...
        <a :href="partner.link" target="_blank">
          <div v-if="partnerCategory.maxImageHeight">
            <div
              v-if="
                partner.height &&
                  partner.height <= partnerCategory.maxImageHeight
              "
            >
              <img
                :style="{ height: partner.height + 'px' }"
                :alt="partner.name"
                :src="thumbUrl(partner)"
                :title="partner.name"
              />
            </div>
            <div
            ...
            >
              <img
                :style="{ height: partnerCategory.maxImageHeight + 'px' }"
                :alt="partner.name"
                :src="thumbUrl(partner)"
                :title="partner.name"
              />
            ...
            <div
              v-else-if="
                partner.logo.height &&
                  partner.logo.height > partnerCategory.maxImageHeight
              "
            >
              <img
                :style="{ height: partnerCategory.maxImageHeight + 'px' }"
